            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Tambah Pilihan</b></h3></center>
                    
                    <?php 
                      $id_kriteria = $_GET['id'];
                      echo' <form class="form theme-form" action="proses-tambah-pilihan.php?id='.$id_kriteria.'" method="post">'; 
                    ?>
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="keterangan" required="required" value="">
                                      </div>
                                    </div>
