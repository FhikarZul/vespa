            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <br>
                  <br>
                    <center><h3><b>Tambah Kriteria</b></h3></center>
                    <form class="form theme-form" action="proses-tambah-kriteria.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="kriteria" required="required" value="" pattern="[a-zA-Z]+">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="number" name="nilai_standar" required="required">
                                      </div>
                                    </div>
