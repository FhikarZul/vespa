            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="tambah-gap.php"><i data-feather="layout"></i><span>Tambah GAP</span></a>
                  </li>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-primary" href="tambah-gap.php">Tambah GAP</a>
                </br></br>        
                <div class="card">
                        ...
                        while ($row = mysqli_fetch_array($query)){
                          echo '
                                  <tr>
                                      ...
                                      <td>'.$row['bobot'].'</td>
                                      <td>'.$row['ket'].'</td>
                                      <td><a class="btn btn-primary" href="edit-gap.php?id='.$row['id_gap'].'">Edit</a></td>
                                      <td><a class="btn btn-danger" href="proses-hapus-gap.php?id='.$row['id_gap'].'">Hapus</a></td>
                                  </tr>';
