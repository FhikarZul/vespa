            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Edit Alternatif</b></h3></center>
                   
                    <?php 
                      $id_alternatif = $_GET['id'];
                      echo '<form class="form theme-form" action="proses-edit-alternatif.php?id='.$id_alternatif.'" method="post">';
                    ?>
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                        ...
                                        <?php
                                          ...
                                          while ($row = mysqli_fetch_array($query)){
                                            echo ' <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="text" name="alternatif" required="required" value="'.$row['alternatif'].'">
                                                    </div>
                                                  </div>';
                                          }
                                        ?>
