            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Edit GAP</b></h3></center>
                    <?php 
                      $id_gap = $_GET['id'];
                      echo '<form class="form theme-form" action="proses-edit-gap.php?id='.$id_gap.'" method="post">';
                    ?>
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                        ...
                                        <?php
                                          ...
                                          $sql = "SELECT * FROM `tb_gap` WHERE `id_gap`='$id_gap'";
                                          $query = mysqli_query($connect, $sql);


                                          while ($row = mysqli_fetch_array($query)){
                                            echo '<div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">GAP</label>
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="number" name="gap" required="required" value="'.$row['gap'].'">
                                                    </div>
                                                  </div>';
                                            ...
                                            echo '<div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="number" name="bobot" required="required" value="'.$row['bobot'].'">
                                                    </div>
                                                  </div>';
                                            ...
                                            echo '<div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="text" name="ket" required="required" value="'.$row['ket'].'">
                                                    </div>
                                                  </div>
                                                ';
                                          }
