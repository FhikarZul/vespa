            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <?php 
                    if(isset($_GET['m'])){
                      if($_GET['m'] == "gagal"){
                        echo '<center><b><p style="margin: 10px"; >Kategori sudah ada.</p></b></center>';
                  ...
                  <br>
                  <br>
                    <center><h3><b>Tambah Kategori</b></h3></center>
                    <form class="form theme-form" action="proses-tambah-kategori.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="kategori" required="required" value="">
                                      </div>
                                    </div>
