            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="kriteria.php"><i data-feather="layout"></i><span>Kriteria</span></a>
                  </li>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <?php 
                    if(isset($_GET['m'])){
                      if($_GET['m'] == "gagal"){
                        echo '<center><b><p style="margin: 10px"; >Kriteria sudah ada.</p></b></center>';
                      }
                    }
                  ?>
                  <br>
                  <br>
                    <center><h3><b>Edit Kriteria</b></h3></center>
                   
                    <?php 
                      $id_kriteria = $_GET['id'];
                      echo '<form class="form theme-form" action="proses-edit-kriteria.php?id='.$id_kriteria.'" method="post">';
                    ?>
                                        ...
                                        <?php
                                          ...
                                          while ($row = mysqli_fetch_array($query)){
                                            ...
                                            echo '<div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="text" name="kriteria" required="required" value="'.$row['kriteria'].'">
                                                    </div>
                                                  </div>';
                                            ...
                                            echo '<div class="mb-3 row">
                                                  ...
                                                  <div class="col-sm-9">
                                                    <select class="form-select digits" id="id" name="status">';
                                                        
                                                        if($row['status']=='cf'){
                                                          echo '<option value="cf" selected>Core Factor</option>';
                                                        }else{
                                                          echo '<option value="cf">Core Factor</option>';
                                                        }

                                                        if($row['status']=='sf'){
                                                          echo '<option value="sf" selected>Secondary Factor</option>';
                                                        }else{
                                                          echo '<option value="sf">Secondary Factor</option>';
                                                        }
                                              echo' </select>
                                                  </div>
                                                </div>';
                                              ...
                                              echo '<div class="mb-3 row">
                                                      <label class="col-sm-3 col-form-label">Target Nilai Standar</label>
                                                      <div class="col-sm-9">
                                                        <input class="form-control" type="number" name="nilai_standar" required="required" value="'.$row['nilai_standar'].'">
                                                      </div>
                                                    </div>';
                                          }
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <select class="form-select digits" id="id" name="kategori">
