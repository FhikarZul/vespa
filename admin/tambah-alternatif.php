            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <?php 
                    if(isset($_GET['m'])){
                      if($_GET['m'] == "gagal"){
                        echo '<center><b><p style="margin: 10px"; >Alternatif sudah ada.</p></b></center>';
                      }else if($_GET['m'] == "symbol_error"){
                        echo '<center><b><p style="margin: 10px"; >Tidak boleh menggunakan symbol khusus.</p></b></center>';
                      }
                    }
                  ?>
                  <br>
                  <br>
                    <center><h3><b>Tambah Alternatif</b></h3></center>
                    <form class="form theme-form" action="proses-tambah-alternatif.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                      <label class="col-sm-3 col-form-label">Merek Motor</label>
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="alternatif" required="required" value="" >
                                      </div>
                                    </div>
