            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <?php 
                    if(isset($_GET['m'])){
                      if($_GET['m'] == "gagal"){
                        echo '<center><b><p style="margin: 10px"; >GAP sudah ada.</p></b></center>';
                      }
                    }
                  ?>
                  <br>
                  <br>
                    ...
                    <form class="form theme-form" action="proses-tambah-gap.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="number" name="gap" required="required" value="">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="number" name="bobot" required="required" value="">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="ket" required="required" value="">
                                      </div>
                                    </div>
