            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="tambah-kategori.php"><i data-feather="layout"></i><span>Tambah Kategori</span></a>
                  </li>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-primary" href="tambah-kategori.php">Tambah Kategori</a>
                </br></br>        
                <div class="card">
                        ...
                        while ($row = mysqli_fetch_array($query)){
                          echo '
                                  <tr>
                                      <td>'.$no.'</td>
                                      <td>'.$row['kategori'].'</td>
                                      <td><a class="btn btn-primary" href="edit-kategori.php?id='.$row['id_kategori'].'">Edit</a></td>
                                      <td><a class="btn btn-danger" href="proses-hapus-kategori.php?id='.$row['id_kategori'].'">Hapus</a></td>
                                  </tr>';
