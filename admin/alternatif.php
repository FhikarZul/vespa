            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="tambah-alternatif.php"><i data-feather="layout"></i><span>Tambah Alternatif</span></a>
                  </li>
                        ...
                        while ($row = mysqli_fetch_array($query)){
                          echo '
                                  <tr>
                                      ...
                                      <td><a class="btn btn-primary" href="edit-alternatif.php?id='.$row['id_alternatif'].'">Edit</a></td>
                                      <td><a class="btn btn-danger" href="proses-hapus-alternatif.php?id='.$row['id_alternatif'].'">Hapus</a></td>
