            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="kategori.php"><i data-feather="layout"></i><span>Kategori</span></a>
                  </li>
                  <li class="dropdown"><a class="nav-link" href="kriteria.php"><i data-feather="layout"></i><span>Kriteria</span></a>
                  </li>
                  <li class="dropdown"><a class="nav-link" href="alternatif.php"><i data-feather="layout"></i><span>Alternatif</span></a>
                  </li>
                  </li>
                  <li class="dropdown"><a class="nav-link" href="gap.php"><i data-feather="layout"></i><span>GAP</span></a>
                  </li>
...
<div class="mySlides fade">
  ...
  <img src="../assets/images/slide/slide1.png" style="width:100%">

</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="../assets/images/slide/slide2.png" style="width:100%">

</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="../assets/images/slide/slide3.png" style="width:100%">
