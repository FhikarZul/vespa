          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                 ...
                 echo '<a class="btn btn-primary" href="tambah-pilihan-kriteria.php?id='.$id_kriteria.'">Tambah Pilihan</a>';
                ?>
                ...
                <div class="table-responsive" style="
                    ...
                    <table class="table">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM `tb_pilihan` WHERE `id_kriteria`='$id_kriteria'";
                        ...
                        while ($row = mysqli_fetch_array($query)){
                          echo '
                                  <tr>
                                      ...
                                      <td>'.$row['pilihan'].'</td>
                                      <td>'.$row['bobot'].'</td>
                                      <td><a class="btn btn-primary" href="edit-pilihan-kriteria.php?id='.$row['id_pilihan'].'&id_kriteria='.$id_kriteria.'">Edit</a></td>
                                      <td><a class="btn btn-danger" href="proses-hapus-pilihan.php?id='.$row['id_pilihan'].'&id_kriteria='.$id_kriteria.'">Hapus</a></td>
                                  </tr>';
