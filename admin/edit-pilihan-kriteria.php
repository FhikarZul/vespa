            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <?php $id_kriteria = $_GET['id']; echo '<li class="dropdown"><a class="nav-link" href="pilihan-kriteria.php?id='.$id_kriteria.'"><i data-feather="layout"></i><span>Pilihan Kriteria</span></a>'; ?>
                  </li>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Edit Pilihan</b></h3></center>
                    
                    <?php 
                      $id_pilihan = $_GET['id'];
                      $id_kriteria = $_GET['id_kriteria'];
                      echo' <form class="form theme-form" action="proses-edit-pilihan.php?id='.$id_pilihan.'&id_kriteria='.$id_kriteria.'" method="post">'; 
                    ?>
                                    ...
                                    <div class="card-body">
                                      <div class="row">
                                        ...
                                        <?php
                                          ...
                                          $sql = "SELECT * FROM `tb_pilihan` WHERE `id_pilihan`='$id_pilihan'";
                                          ...
                                          while ($row = mysqli_fetch_array($query)){
                                            echo '<div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="text" name="keterangan" required="required" value="'.$row['pilihan'].'">
                                                    </div>
                                                  </div>';
