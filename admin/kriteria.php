            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="tambah-kriteria.php"><i data-feather="layout"></i><span>Tambah Kriteria</span></a>
                  </li>
                    ...
                    <table class="table">
                      <thead>
                        <tr> 
                          ...
                          <th scope="col">Target Nilai Standar</th>
                      ...
                      <?php
                        ...
                        $sql = "SELECT `id_kriteria`, `kriteria`, `status`, `nilai_standar`, `kode`, `tb_kategori`.kategori as 'kategori' FROM `tb_kriteria`, `tb_kategori` WHERE `tb_kategori`.id_kategori=`tb_kriteria`.id_kategori ORDER BY `id_kriteria` ASC";
                        ...
                        while ($row = mysqli_fetch_array($query)){
                          echo '
                                  <tr>
                                      ...
                                      <td>'.$row['kategori'].'</td>
                                      <td><a class="btn btn-primary" href="pilihan-kriteria.php?id='.$row['id_kriteria'].'">Lihat</a></td>
                                      <td><a class="btn btn-primary" href="edit-kriteria.php?id='.$row['id_kriteria'].'">Edit</a></td>
                                      ';
                                      if($total_kriteria==$no){
                                        echo '<td><a class="btn btn-danger" href="proses-hapus-kriteria.php?id='.$row['id_kriteria'].'">Hapus</a></td>';
                                      }
                            echo '</tr>';
