            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Edit Kategori</b></h3></center>
                    <?php 
                      $id_kategori = $_GET['id'];
                      echo '<form class="form theme-form" action="proses-edit-kategori.php?id='.$id_kategori.'" method="post">';
                    ?>
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                        ...
                                        <?php
                                          ...
                                          while ($row = mysqli_fetch_array($query)){
                                            echo '<div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input class="form-control" type="text" name="kategori" required="required" value="'.$row['kategori'].'">
                                                    </div>
                                                  </div>';
                                          }
                                        ?>
