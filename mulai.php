          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-primary" href="input-nilai-kriteria.php">Input Nilai Kriteria</a>
                </br></br>        
                <div class="card">
                ...
                <div class="table-responsive" style="
                    ...
                    <thead>
                      ...
                      <?php
                        ...
                        $sql .= " `tb_alternatif`.alternatif, `id_jawaban` FROM `tb_jawaban_user`,`tb_alternatif` WHERE `tb_alternatif`.id_alternatif = `tb_jawaban_user`.id_alternatif AND `id_user`=".$id_user;
                        ...
                        while ($row = mysqli_fetch_array($query)){
                          ...
                          echo '<tr>
                                    ...
                                    echo '<td><a class="btn btn-danger" href="proses-hapus-input-nilai-kriteria.php?id='.$row['id_jawaban'].'">Hapus</a></td>';
                    ...
                    <?php
                      if($status){
                        echo '
                              ...
                              <center><p>Tidak ada data, harap memasukkan kriteria</p></center>
                            ';
                      }
                    ?>
                    ...
                    <div class="card-footer text-end">
                      <?php
                        if(!$status){
                          echo '
                                  <a class="btn btn-primary" href="proses-analisis.php">Mulai Analisa</a>
                              ';
                        }
                      ?>
