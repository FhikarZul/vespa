            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="riwayat.php"><i data-feather="layout"></i><span>Riwayat</span></a>
                  </li>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-danger" href="proses-hapus-riwayat.php">Reset Riwayat</a>
                </br></br>        
                <div class="card">
                    ...
                    <?php
                      if($status){
                        echo '
                              ...
                              <center><p>Tidak ada riwayat terakhir!</p></center>
                            ';
                      }
                    ?>
