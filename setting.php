            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Pengaturan</b></h3></center>
                    <form class="form theme-form" action="proses-setting.php" method="post"">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                        ...
                        <?php
                          ...
                          while ($row = mysqli_fetch_array($query)){
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="username" required="required" value="'.$row['username'].'">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="password" required="required" value="'.$row['password'].'">
                                      </div>
                                    </div>
